...
namespace chess
{
  ...
  void ChessPrefContext::procDialog()
  {
  ...
  void ChessPrefContext::saveDialogResult(String& result_str)
  {
    ...
    switch (_dialog_id)
    {
        // case DIALOG_ID_SERVER_CONN:  // Якщо в режимі підключення до сервера // TODO
        //   String _serv_pwd = dialog_txt->getText();
    ...
    if (PREF_FIELD_NAME && SettingsManager::set(PREF_FIELD_NAME, result_str.c_str(), STR_CHESS_GAME_DIR))
