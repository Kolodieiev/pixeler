...
namespace pixeler
{
  ...
  public:
    ...
    /**
     * @brief Встановлює стан прапора, який керує механізмом відображення межі віджету.
    ...
    /**
     * @brief Встановлює стан прапора, який керує відображенням межі віджета та її кольором, під час потрапляння фокусу на нього.
     *
    ...
    /**
     * @brief Встановлює стан прапора, який керує зміною кольору фону під час отримання фокусу віджетом.
     *
    ...
    /**
     * @brief Повертає стан прапора, який вказує, чи є віджет прозорим.
     *
