...
struct esp_rgb_panel_t
{
  ...
  int x_gap;                                                    // Extra gap in x coordinate, it's used when calculate the flushMainBuff window
  int y_gap;                                                    // Extra gap in y coordinate, it's used when calculate the flushMainBuff window
  struct
  {
